...
// specificity: "Auto Rifle" instead of just "Weapon" for example, or "Vanguard Bounty" instead
// of merely "Bounty".
// These sub-types are provided for historical compatibility with Destiny 1, but an ideal
...
// arbitrary hierarchies of specificity, and for items to belong to multiple categories across
// multiple hierarchies simultaneously. For this enum, we pick a single type as a "best guess"
// fit.
